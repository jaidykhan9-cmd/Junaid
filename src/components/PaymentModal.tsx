...
export const PaymentModal: React.FC<PaymentModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md overflow-y-auto">
      <div className="relative w-full max-w-lg bg-[#0e1017] border border-[#d4af37]/35 rounded-xl shadow-[0_20px_60px_rgba(0,0,0,0.8)] overflow-hidden my-6">
          ...
          {successResult ? (
            <div className="text-center py-4 space-y-4">
              ...
              <p className="text-xs text-[#94a3b8] max-w-sm mx-auto leading-relaxed">
                Your transaction TID <strong className="text-[#f8fafc] font-mono">{successResult.transactionRef}</strong> for booking <strong className="text-[#f8fafc] font-mono">{successResult.bookingId}</strong> has been logged. Admin will review the proof and approve.
              </p>

              <button
                onClick={onClose}
                className="mt-4 px-6 py-2.5 bg-[#d4af37] text-[#08090d] rounded text-xs font-bold uppercase tracking-wider cursor-pointer hover:bg-[#fae8b4] transition-colors"
              >
                Close Window
              </button>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="p-4 rounded-lg bg-[#121520] border border-[#d4af37]/25 space-y-2 text-xs">
                ...
                <div className="flex justify-between items-center text-[#94a3b8] pt-1">
                  ...
                  <strong className="text-[#f8fafc]">Junaid Farooq (CEO)</strong>
                </div>
                <div className="flex justify-between items-center text-[#94a3b8]">
                  <span>JazzCash Mobile Number:</span>
                  <div className="flex items-center gap-2">
                    <strong className="text-[#fae8b4] font-mono">03021822160</strong>
                    <button
                      type="button"
                      onClick={copyNumber}
                ...
                <p className="text-[11px] text-[#94a3b8]/70 pt-1 border-t border-white/5">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-[#121520] border border-white/10 rounded-lg p-2.5 text-xs text-[#f8fafc] focus:outline-none focus:border-[#d4af37] font-mono"
                  required
                />
              </div>
              ...
              <div>
                ...
                <label className="flex items-center justify-center gap-2 p-3 bg-[#121520] border border-dashed border-white/15 rounded-lg text-xs text-[#94a3b8] hover:border-[#d4af37] cursor-pointer transition-colors">
              ...
              <div className="pt-2">
                <button
                  ...
                  className="w-full py-3 bg-gradient-to-r from-[#fae8b4] via-[#d4af37] to-[#aa820a] text-[#08090d] rounded-lg text-xs font-bold uppercase tracking-wider hover:brightness-110 transition-all shadow-md disabled:opacity-50 cursor-pointer"
                >
