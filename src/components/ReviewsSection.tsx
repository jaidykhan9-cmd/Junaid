...
export const ReviewsSection: React.FC = () => {
  ...
  return (
    <section id="reviews" className="py-24 bg-[#080a0f] relative border-t border-[#d4af37]/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12">
          ...
          <button
            ...
            className="mt-6 md:mt-0 flex items-center gap-2 px-5 py-2.5 rounded bg-[#161a26] hover:bg-[#202538] border border-[#d4af37]/35 text-xs font-semibold text-[#fae8b4] transition-all cursor-pointer self-start md:self-auto"
          >
        ...
        {loading ? (
          ...
          <div className="luxury-card rounded-xl p-10 text-center max-w-2xl mx-auto">
            ...
            <button
              onClick={() => setIsModalOpen(true)}
              className="mt-6 px-5 py-2.5 bg-[#d4af37] text-[#08090d] text-xs font-bold uppercase tracking-wider rounded hover:bg-[#fae8b4] transition-colors"
            >
            ...
            {reviews.map((rev) => (
              <div key={rev.id} className="luxury-card rounded-lg p-6 flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-xs text-[#f8fafc] leading-relaxed italic">
                    "{rev.comment}"
                  </p>
                </div>
                ...
                <div className="mt-6 pt-4 border-t border-white/5 flex items-center justify-between text-xs">
                  <div>
                    <div className="font-bold text-[#f8fafc]">{rev.customerName}</div>
                    <div className="text-[11px] text-[#94a3b8] capitalize">{rev.serviceCategory} Client</div>
                  </div>
                ...
                <form onSubmit={handleSubmitReview} className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs font-bold text-[#fae8b4] ml-2">
                        {rating} of 5 Stars
                      </span>
                    </div>
                  </div>
