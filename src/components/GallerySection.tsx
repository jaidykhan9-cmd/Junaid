...
const PROJECTS_DATA: ProjectItem[] = [
  {
    id: 'proj-real-1',
    title: 'Mansehra Mountain Terrace High-Altitude Conduit Installation',
    category: 'Electrical',
    location: 'Scenic Mountain Heights, Mansehra Valley',
    year: '2025',
    image: '/src/assets/images/gallery_rooftop_conduit_1790196535981.jpg',
    description: 'Direct on-site engineering execution: High-elevation structural terrace conduit routing, heavy-duty electrical wiring channels, and weather-resistant junction anchoring overlooking the Mansehra valley.',
    specs: ['UV-Stabilized High-Impact PVC Conduit', 'Precision Seismic Clamping Saddles', 'Concealed Weatherproof Routing for Extreme Climates'],
  },
  {
    id: 'proj-real-2',
    title: 'Precision Sub-Floor Sanitary & PPR Water Supply Network',
    category: 'Plumbing',
    location: 'Central Mansehra Construction Site',
    year: '2025',
    image: '/src/assets/images/gallery_plumbing_pipeline_1790196554220.jpg',
    description: 'Direct on-site engineering assembly: Complete sub-floor hydraulic water distribution grid utilizing high-grade green PPR heat-fused pipelines seamlessly integrated with high-velocity PVC soil and waste manifolds.',
    specs: ['High-Thermal PPR Heat-Fusion Welded Joints', 'Laser-Leveled Gravity Flow Drainage Slopes', 'Dual Cleanout Inspection Ports with Odor Seals'],
  },
  {
    id: 'proj-1',
...
export const GallerySection: React.FC = () => {
  ...
  return (
    <section id="gallery" className="py-24 bg-[#080a0f] relative border-t border-[#d4af37]/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12">
          <div>
            ...
            <p className="mt-3 text-sm text-[#94a3b8] max-w-xl">
              Inspect real MEP infrastructure installed, certified, and maintained by JD Electrical &amp; Plumbing Services.
            </p>
          </div>

          {/* Category Tabs */}
          <div className="mt-6 md:mt-0 flex flex-wrap gap-1 p-1 bg-[#121520] rounded border border-[#d4af37]/25">
            {categories.map((cat) => (
              <button
                key={cat}
            ...
            >
              <div className="relative h-64 sm:h-72 overflow-hidden">
                ...
                <div className="absolute top-4 left-4 z-10">
                  {project.id.startsWith('proj-real') && (
                    <span className="text-[10px] uppercase font-bold tracking-wider px-2.5 py-1 rounded bg-[#08090d]/90 border border-[#d4af37] text-[#fae8b4] shadow-[0_0_12px_rgba(212,175,55,0.4)] backdrop-blur-md flex items-center gap-1.5">
                      <span className="w-1.5 h-1.5 rounded-full bg-[#d4af37] animate-pulse" />
                      Authentic Field Photo
                    </span>
                  )}
                </div>
                <div className="absolute top-4 right-4 bg-[#0e1017]/80 backdrop-blur-md p-2 rounded border border-white/10 text-[#d4af37] opacity-0 group-hover:opacity-100 transition-opacity">
                ...
                <div className="absolute bottom-4 left-4 right-4">
                  ...
                  <h3 className="font-display font-bold text-lg sm:text-xl text-[#f8fafc] group-hover:text-[#fae8b4] transition-colors">
                    {project.title}
                  </h3>
                </div>
              </div>
              ...
              <div className="p-6">
                ...
                <div className="mt-4 pt-3 border-t border-white/5 flex items-center justify-between text-xs text-[#d4af37]">
                  ...
                  {project.beforeImage && (
                    <span className="text-[10px] text-[#fae8b4] bg-[#1a2030] px-2 py-0.5 rounded border border-[#d4af37]/30">
        ...
        {selectedProject && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/90 backdrop-blur-lg">
            <div className="relative w-full max-w-4xl bg-[#0e1017] border border-[#d4af37]/40 rounded-xl overflow-hidden shadow-2xl">
              ...
              <div className="p-4 bg-[#141724] border-b border-white/10 flex items-center justify-between">
                ...
                <button
                  ...
                  className="p-1.5 text-[#94a3b8] hover:text-white rounded hover:bg-white/10"
                >
                  <X className="w-5 h-5" />
                </button>
              </div>
              ...
              <div className="relative h-80 sm:h-96 bg-black flex items-center justify-center overflow-hidden">
                ...
                {selectedProject.beforeImage && (
                  <button
                    ...
                    className="absolute bottom-4 right-4 bg-[#141724]/90 border border-[#d4af37] text-[#fae8b4] text-xs font-bold px-3 py-1.5 rounded flex items-center gap-1.5 shadow-lg hover:bg-[#1e2334] transition-all cursor-pointer"
                  >
                ...
                <div className="mt-4 pt-4 border-t border-white/10">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-2">
                    {selectedProject.specs.map((spec, sIdx) => (
                      <div key={sIdx} className="p-2.5 rounded bg-white/5 border border-white/5 text-xs text-[#f8fafc] flex items-center gap-2">
