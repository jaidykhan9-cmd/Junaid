...
export const BookingStepper: React.FC<BookingStepperProps> = ({
  ...
  return (
    <div className="w-full bg-[#0d1017] border-b border-[#d4af37]/20 px-4 sm:px-6 py-3.5 select-none">
      {/* Mobile Compact Header & Progress Summary */}
      <div className="flex md:hidden items-center justify-between text-xs mb-2.5">
        <div className="flex items-center gap-2">
          <span className="inline-flex items-center justify-center w-5 h-5 rounded-full bg-[#d4af37] text-[#08090d] font-bold text-[10px]">
            {effectiveStep}
          </span>
          <span className="font-semibold text-[#fae8b4]">
      ...
      <div className="w-full h-1.5 bg-[#141824] rounded-full overflow-hidden mb-3 md:hidden">
        <div
          className="h-full bg-gradient-to-r from-[#d4af37] via-[#fae8b4] to-[#aa820a] transition-all duration-300 rounded-full"
      ...
      <div className="relative">
        ...
        <div className="hidden md:block absolute top-[18px] left-[32px] right-[32px] h-[2px] bg-[#141824] -z-0" />
        
        {/* Dynamic Highlighted Progress Line */}
        <div
          className="hidden md:block absolute top-[18px] left-[32px] h-[2px] bg-gradient-to-r from-[#d4af37] via-[#fae8b4] to-[#aa820a] transition-all duration-500 -z-0"
          style={{
                ...
                <div
                  className={`w-9 h-9 rounded-full flex items-center justify-center transition-all duration-300 relative z-10 ${
                    isCompleted
                      ...
                      : isCurrent
                      ? 'bg-[#181d2c] text-[#fae8b4] border-2 border-[#d4af37] shadow-[0_0_16px_rgba(212,175,55,0.5)] ring-4 ring-[#d4af37]/20 scale-105'
                      : 'bg-[#0e111a] text-[#94a3b8] border border-white/10 group-hover:border-white/20'
                  }`}
                >
                  {isCompleted ? (
                ...
                <div className="mt-1.5 text-center">
                  <div
                    className={`text-[10px] uppercase font-bold tracking-tight transition-colors line-clamp-1 ${
                      isCurrent
                        ? 'text-[#fae8b4] font-extrabold drop-shadow-[0_1px_4px_rgba(212,175,55,0.5)]'
                        : isCompleted
                        ? 'text-[#d4af37]'
                        : 'text-[#6f5b50]'
                    }`}
                  ...
                  <div className="hidden lg:block text-[9px] text-[#64748b] font-mono leading-none mt-0.5">
                    Step {step.number}
                  </div>
                </div>
