  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-40 p-3.5 bg-gradient-to-r from-[#d4af37] via-[#fae8b4] to-[#aa820a] text-[#08090d] rounded-full shadow-[0_4px_25px_rgba(212,175,55,0.4)] hover:scale-105 active:scale-95 transition-all flex items-center justify-center cursor-pointer"
      ...
      {/* Chat Window */}
      {isOpen && (
        <div className="fixed bottom-22 right-4 sm:right-6 z-40 w-[94vw] sm:w-[400px] h-[520px] max-h-[82vh] bg-[#0c0e15] border border-[#d4af37]/40 rounded-2xl shadow-[0_20px_60px_rgba(0,0,0,0.85)] flex flex-col overflow-hidden backdrop-blur-xl animate-in fade-in slide-in-from-bottom-4 duration-200">
          
          {/* Header */}
          <div className="bg-[#141724] border-b border-[#d4af37]/25 p-4 flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              <div className="w-9 h-9 rounded-full bg-[#08090d] border border-[#d4af37]/50 flex items-center justify-center text-[#d4af37]">
          ...
          {/* Messages Feed */}
          <div className="flex-1 p-4 overflow-y-auto space-y-3 bg-[#08090d]/80">
            {messages.map((m) => (
              <div
                key={m.id}
              ...
              >
                <div
                  className={`max-w-[85%] rounded-xl p-3 text-xs leading-relaxed whitespace-pre-wrap ${
                    m.sender === 'user'
                      ? 'bg-[#d4af37] text-[#08090d] font-semibold rounded-br-none'
                      : 'bg-[#141724] border border-[#d4af37]/20 text-[#f8fafc] rounded-bl-none shadow-sm'
                  }`}
                >
                  {m.text}
                </div>
                <span className="text-[10px] text-[#64748b] mt-1 px-1">{m.timestamp}</span>
                  ...
                  <div className="flex flex-wrap gap-1.5 mt-2 max-w-[95%]">
                    {m.quickReplies.map((qr, qIdx) => (
                      <button
                        ...
                        className="px-2.5 py-1 rounded bg-[#10131d] hover:bg-[#1a2030] border border-[#d4af37]/30 text-[11px] text-[#fae8b4] transition-colors cursor-pointer"
                      >
                        {qr}
                      </button>
                    ))}
          ...
          {/* Quick Shortcuts Bar */}
          <div className="px-3 py-1.5 bg-[#090b10] border-t border-white/5 flex items-center justify-between text-[11px] text-[#94a3b8]">
            <a
            ...
            <button
              ...
              className="hover:text-[#fae8b4] cursor-pointer"
            >
              JazzCash
            </button>
          </div>
          ...
          <form
            ...
            className="p-3 bg-[#0c0e15] border-t border-[#d4af37]/20 flex items-center gap-2"
          >
            <input
              type="text"
              ...
              className="flex-1 bg-[#08090d] border border-white/10 rounded-lg px-3 py-2 text-xs text-[#f8fafc] focus:outline-none focus:border-[#d4af37]"
            />
            <button
              type="submit"
              className="p-2 bg-[#d4af37] hover:bg-[#fae8b4] text-[#08090d] rounded-lg transition-colors cursor-pointer"
            >
