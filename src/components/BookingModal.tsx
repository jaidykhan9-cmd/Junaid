...
export const BookingModal: React.FC<BookingModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-black/80 backdrop-blur-md overflow-y-auto">
      <div className="relative w-full max-w-3xl bg-[#0e111a] border border-[#d4af37]/35 rounded-xl shadow-[0_20px_60px_rgba(0,0,0,0.8)] overflow-hidden my-6">
        
        {/* Modal Header */}
        <div className="bg-[#141824] border-b border-[#d4af37]/20 px-6 py-4 flex items-center justify-between">
          <div>
          ...
          <button
            onClick={onClose}
            className="p-1.5 rounded text-[#94a3b8] hover:text-[#f8fafc] hover:bg-white/5 transition-colors cursor-pointer"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        <div className="p-6 max-h-[72vh] overflow-y-auto">
          ...
          {submittedBooking ? (
            <div className="text-center py-6">
              ...
              <p className="mt-2 text-xs text-[#94a3b8] max-w-md mx-auto">
                Your service booking has been registered and directly sent to <strong className="text-[#fae8b4]">JD's team</strong> (<strong className="text-[#d4af37]">jaidykhan9@gmail.com</strong>). Our dispatch crew is reviewing your request for technician deployment.
              </p>

              {/* ID Badges */}
              <div className="mt-6 p-4 rounded-lg bg-[#0d1017] border border-[#d4af37]/35 max-w-md mx-auto text-left space-y-2">
                <div className="flex items-center justify-between text-xs">
                  <span className="text-[#94a3b8]">Official Booking ID:</span>
                  <div className="flex items-center gap-1.5 font-mono font-bold text-[#fae8b4]">
                ...
                <div className="flex items-center justify-between text-xs pt-2 border-t border-white/10">
                  ...
                  <span className="font-medium text-[#f8fafc]">{submittedBooking.serviceTitle}</span>
                </div>

                <div className="flex items-center justify-between text-xs">
                  <span className="text-[#94a3b8]">Scheduled Window:</span>
              ...
              <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3">
                ...
                {onOpenPayment && (
                  <button
                    ...
                    className="w-full sm:w-auto px-5 py-2.5 bg-[#d4af37] hover:bg-[#fae8b4] text-[#08090d] rounded text-xs font-bold flex items-center justify-center gap-2 cursor-pointer shadow-md"
                  >
                ...
                <button
                  onClick={onClose}
                  className="w-full sm:w-auto px-4 py-2.5 bg-white/5 hover:bg-white/10 text-[#94a3b8] rounded text-xs"
                >
                  Close
                </button>
              </div>
            ...
            <AnimatePresence mode="wait">
              ...
              {currentStep === 1 && (
                ...
                >
                  <div className="flex items-center gap-2 mb-2">
                    <button
                      ...
                      className={`flex-1 py-2 text-xs font-semibold rounded border transition-all ${
                        category === 'electrical'
                          ? 'bg-[#161a28] text-[#38bdf8] border-[#38bdf8]/50'
                          : 'bg-[#090c13] text-[#94a3b8] border-white/5'
                      }`}
                    >
                    ...
                    <button
                      ...
                      className={`flex-1 py-2 text-xs font-semibold rounded border transition-all ${
                        category === 'plumbing'
                          ? 'bg-[#161a28] text-[#22d3ee] border-[#22d3ee]/50'
                          : 'bg-[#090c13] text-[#94a3b8] border-white/5'
                      }`}
                    >
                    ...
                    <button
                      ...
                      className={`flex-1 py-2 text-xs font-semibold rounded border transition-all ${
                        category === 'package'
                          ? 'bg-[#161a28] text-[#d4af37] border-[#d4af37]/50'
                          : 'bg-[#090c13] text-[#94a3b8] border-white/5'
                      }`}
                    >
                  ...
                  <div className="space-y-2 mt-3">
                    <label className="text-xs font-medium text-[#94a3b8]">Select Specific Service</label>
                      ...
                      {category === 'package'
                            ...
                            <div
                              ...
                              className={`p-3 rounded border text-left cursor-pointer transition-all ${
                                serviceTitle === pkg.name
                                  ? 'bg-[#161a28] border-[#d4af37] text-[#f8fafc]'
                                  : 'bg-[#090c13] border-white/5 hover:border-white/20 text-[#94a3b8]'
                              }`}
                            >
                              ...
                              <div className="text-[11px] text-[#94a3b8] mt-1">{pkg.description}</div>
                            </div>
                          ))
                        : (category === 'electrical' ? ELECTRICAL_SERVICES : PLUMBING_SERVICES).map((srv) => (
                            ...
                            >
                              ...
                              <div className="text-[11px] text-[#94a3b8] mt-1">{srv.shortDesc}</div>
                            </div>
                          ))}
                    </div>
                  </div>
                ...
                >
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full bg-[#090c13] border border-white/10 rounded-lg p-3 text-xs text-[#f8fafc] focus:outline-none focus:border-[#d4af37]"
                    />
                    <p className="text-[11px] text-[#94a3b8]/70 mt-1">
                      ...
                      {['Standard (Next available slot)', 'High Priority (< 24 Hours)', 'Critical Emergency (< 2 Hours)'].map((lvl) => (
                        <button
                          ...
                          className={`p-2.5 rounded border text-xs text-left transition-all ${
                            urgency === lvl
                              ? 'bg-[#161a28] border-[#d4af37] text-[#fae8b4]'
                              : 'bg-[#090c13] border-white/5 text-[#94a3b8]'
                          }`}
                        >
                          {lvl}
                        </button>
              ...
              {currentStep === 5 && (
                ...
                >
                  <div>
                    ...
                    >
                      {MANSEHRA_NEIGHBORHOODS.map((n) => (
                        <option key={n} value={n} className="bg-[#090c13]">
                          {n}
                        </option>
                      ))}
                    </select>
                  ...
                  <div className="p-3 bg-[#090c13] rounded-lg border border-white/5 flex items-center justify-between">
                    <div>
                      <div className="text-xs text-[#f8fafc] font-medium flex items-center gap-1.5">
              ...
              {currentStep === 6 && (
                <motion.div
                  ...
                  className="space-y-4"
                >
                  <div className="border-2 border-dashed border-[#d4af37]/30 rounded-xl p-6 text-center bg-[#090c13]/50 hover:bg-[#090c13] transition-all">
                    ...
                    <label className="inline-flex items-center gap-2 px-4 py-2 bg-[#161a28] hover:bg-[#1f2538] border border-[#d4af37]/40 text-[#fae8b4] text-xs font-medium rounded cursor-pointer transition-all">
              ...
              {currentStep === 7 && (
                ...
                >
                  ...
                  <div className="bg-[#090c13] border border-white/10 rounded-lg p-4 space-y-3 text-xs">
                    <div className="flex justify-between border-b border-white/5 pb-2">
                      <span className="text-[#94a3b8]">Selected Service:</span>
                      <strong className="text-[#f8fafc]">{serviceTitle}</strong>
                    </div>

                    <div className="flex justify-between border-b border-white/5 pb-2">
                      <span className="text-[#94a3b8]">Category &amp; Urgency:</span>
                      <span className="text-[#fae8b4] capitalize">{category} · {urgency}</span>
                    </div>

                    <div className="flex justify-between border-b border-white/5 pb-2">
                      <span className="text-[#94a3b8]">Preferred Schedule:</span>
                      <span className="text-[#f8fafc]">{preferredDate} ({preferredTime})</span>
                    </div>

                    <div className="flex justify-between border-b border-white/5 pb-2">
                      <span className="text-[#94a3b8]">Customer Contact:</span>
                      <span className="text-[#f8fafc]">{customerName} · {phone}</span>
                    </div>

                    <div className="flex justify-between border-b border-white/5 pb-2">
                      <span className="text-[#94a3b8]">Address:</span>
                      <span className="text-[#f8fafc] text-right max-w-xs">{streetAddress}, {neighborhood}</span>
                    </div>

                    <div className="flex justify-between pt-1">
                      <span className="text-[#94a3b8]">Problem Notes:</span>
                      <span className="text-[#f8fafc] text-right max-w-xs italic line-clamp-2">
                        {problemDescription}
                      </span>
                    </div>
                  </div>

                  <div className="p-3 bg-[#141824]/80 border border-[#d4af37]/35 rounded text-[11px] text-[#fae8b4]">
        ...
        {!submittedBooking && (
          <div className="bg-[#0d1017] border-t border-[#d4af37]/20 px-6 py-4 flex items-center justify-between">
            <button
              type="button"
              onClick={handleBack}
              ...
              className={`px-4 py-2 text-xs font-semibold rounded flex items-center gap-1 transition-colors ${
                currentStep === 1
                  ...
                  : 'text-[#f8fafc] hover:bg-white/5 border border-white/10 cursor-pointer'
              }`}
            >
            ...
            {currentStep < 7 ? (
              <button
                type="button"
                onClick={handleNext}
                className="px-6 py-2.5 text-xs font-bold uppercase tracking-wider text-[#08090d] bg-gradient-to-r from-[#fae8b4] via-[#d4af37] to-[#aa820a] hover:brightness-110 rounded flex items-center gap-1.5 transition-all shadow-md cursor-pointer"
              >
                <span>Continue</span>
              ...
              <button
                ...
                className="px-6 py-2.5 text-xs font-bold uppercase tracking-wider text-[#08090d] bg-gradient-to-r from-[#fae8b4] via-[#d4af37] to-[#aa820a] hover:brightness-110 rounded flex items-center gap-1.5 transition-all shadow-md cursor-pointer disabled:opacity-50"
              >
                {isSubmitting ? (
