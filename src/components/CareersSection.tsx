...
export const CareersSection: React.FC = () => {
  ...
  return (
    <section id="careers" className="py-24 bg-[#0a0c12] relative border-t border-[#d4af37]/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Positions List */}
        {loading ? (
          <div className="text-xs text-[#94a3b8] py-8">Loading positions...</div>
        ) : (
            ...
            {positions.map((pos) => (
              ...
              >
                <div>
                  ...
                  <h3 className="font-display font-bold text-lg text-[#f8fafc] leading-snug">
                    {pos.title}
                  </h3>

                  <div className="flex items-center gap-1.5 text-xs text-[#94a3b8] mt-2 mb-4">
                  ...
                  <div className="p-3 bg-[#08090d] rounded border border-white/5 text-[11px] text-[#f8fafc]">
                ...
                <div className="mt-6 pt-4 border-t border-white/5">
                  <button
                    ...
                    className="w-full py-2.5 bg-white/5 hover:bg-[#d4af37] hover:text-[#08090d] text-[#f8fafc] text-xs font-bold uppercase tracking-wider rounded border border-white/10 transition-colors flex items-center justify-center gap-2 cursor-pointer font-medium"
                  >
        ...
        {selectedJob && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md">
            <div className="relative w-full max-w-lg bg-[#0e1017] border border-[#d4af37]/35 rounded-xl overflow-hidden shadow-2xl">
              
              <div className="bg-[#141724] p-4 border-b border-[#d4af37]/20 flex items-center justify-between">
                <div>
              ...
              <div className="p-6 max-h-[75vh] overflow-y-auto">
                ...
                {success ? (
                  <div className="text-center py-6">
                    ...
                    <button
                      onClick={() => setSelectedJob(null)}
                      className="mt-6 px-5 py-2 bg-[#d4af37] text-[#08090d] text-xs font-bold uppercase tracking-wider rounded cursor-pointer"
                    >
                      Close Window
                    </button>
                  </div>
                  ...
                  <form onSubmit={handleApply} className="space-y-3">
                    ...
                    <div>
                      ...
                      <label className="flex items-center justify-center gap-2 p-2.5 bg-[#121520] border border-dashed border-white/15 rounded-lg text-xs text-[#94a3b8] hover:border-[#d4af37] cursor-pointer">
                    ...
                    <div className="pt-2">
                      <button
                        type="submit"
                        disabled={submitting}
                        className="w-full py-2.5 bg-[#d4af37] hover:bg-[#fae8b4] text-[#08090d] font-bold text-xs uppercase tracking-wider rounded transition-colors disabled:opacity-50 cursor-pointer"
                      >
