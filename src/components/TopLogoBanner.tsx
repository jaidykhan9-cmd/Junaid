...
export const TopLogoBanner: React.FC = () => {
  ...
  return (
    <div className="relative w-full overflow-hidden bg-gradient-to-r from-[#080a0f] via-[#10131d] to-[#080a0f] border-b border-[#d4af37]/30 text-xs py-2 select-none z-50">
      ...
      */}
      ...
      >
        <div className="flex items-center gap-2 px-3.5 py-1 rounded-full bg-gradient-to-r from-[#141724] via-[#1c2132] to-[#141724] border-2 border-[#d4af37] shadow-[0_0_24px_rgba(212,175,55,0.45)] backdrop-blur-md">
          {/* Glowing Animated JD Logo Crest with golden ring */}
          <div className="relative w-6 h-6 rounded-full bg-gradient-to-br from-[#d4af37] via-[#aa820a] to-[#1a1e2d] p-[1px] flex items-center justify-center shadow-md">
            <div className="w-full h-full rounded-full bg-[#0a0c12] flex items-center justify-center font-serif-lux font-bold text-xs text-[#fae8b4]">
              <span>JD</span>
            </div>
            <span className="absolute -top-0.5 -right-0.5 w-2 h-2 rounded-full bg-[#d4af37] animate-ping" />
          </div>

          <div className="flex items-center gap-1.5 text-[11px] font-display font-bold tracking-wider uppercase text-[#f8fafc] whitespace-nowrap">
            <span className="text-[#fae8b4] font-extrabold drop-shadow-[0_1px_4px_rgba(212,175,55,0.4)]">JD</span>
            <span className="text-[#f8fafc]">Services</span>
      ...
      <div className="flex w-[200%] overflow-hidden">
        ...
        >
          ...
          {[...bannerItems, ...bannerItems, ...bannerItems, ...bannerItems].map((item, idx) => (
            <div key={idx} className="flex items-center gap-4 text-[11px] uppercase tracking-wider text-[#94a3b8]">
              {/* JD Logo Badge moving left to right */}
              <div className="flex items-center gap-1.5 px-2 py-0.5 rounded bg-white/5 border border-[#d4af37]/30 text-[#fae8b4] font-bold">
                <div className="w-4 h-4 rounded-sm bg-[#1a1e2c] border border-[#d4af37]/60 flex items-center justify-center font-serif-lux text-[9px] text-[#d4af37]">
                  JD
                </div>
                <span className="tracking-widest font-mono text-[10px] text-[#d4af37]">EST. 2018</span>
              </div>

              <span className="font-semibold text-[#f8fafc]">{item.text}</span>
