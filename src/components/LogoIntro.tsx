...
export const LogoIntro: React.FC<LogoIntroProps> = ({ onComplete }) => {
  ...
  if (prefersReducedMotion) {
    return (
      <div className="fixed inset-0 z-50 bg-[#090c13] flex items-center justify-center">
        <div className="text-center">
          <div className="font-serif-lux text-3xl font-bold tracking-wider text-[#d4af37]">JD</div>
          <div className="text-xs uppercase tracking-widest text-[#f8fafc] mt-2">JD Electrical &amp; Plumbing Services</div>
        </div>
      </div>
    );
  }
    ...
    <AnimatePresence>
      {step < 5 && (
        <motion.div
          ...
          className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-[#090c13] overflow-hidden select-none"
        >
          {/* Subtle Ambient Particle / Glow Layer */}
          <div className="absolute inset-0 pointer-events-none">
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-[#1f2538]/40 rounded-full blur-[100px]" />
            <motion.div
          ...
          <div className="relative flex flex-col items-center z-10">
            ...
            <div className="relative w-28 h-28 flex items-center justify-center">
              ...
              <motion.div
                ...
                className="absolute flex items-center justify-center font-serif-lux font-bold text-3xl tracking-widest text-[#fae8b4] drop-shadow-[0_2px_10px_rgba(212,175,55,0.4)]"
              >
                <span>J</span>
            ...
            <div className="mt-6 text-center overflow-hidden">
              <motion.div
                ...
                className="font-display font-semibold text-lg md:text-xl tracking-tight text-[#f8fafc]"
              >
          ...
          <button
            onClick={onComplete}
            className="absolute bottom-6 right-8 text-[11px] tracking-widest uppercase text-[#94a3b8]/60 hover:text-[#d4af37] transition-colors py-1 px-2.5 rounded border border-white/5 hover:border-[#d4af37]/30"
          >
            Skip Intro
          </button>
        </motion.div>
